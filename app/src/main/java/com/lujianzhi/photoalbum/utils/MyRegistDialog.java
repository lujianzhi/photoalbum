 ...
 */
public class MyRegistDialog extends Dialog {
    ...
    public MyRegistDialog(Context context, int themeResId) {
    ...
    private void initView() {
        ...
        negative = (TextView) popView.findViewById(R.id.cancle);
        ...
        positive.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(phoneNumberStr) || TextUtils.isEmpty(passwordStr)) {
                    ...
                    UserManager.getInstance().registerUser(context, user, MyRegistDialog.this);
                }
            }
        });
